...
from utils.map_utils import print_camera_locations, assign_heatmap_colors
...
available_cameras = available_cameras[0:2]
...
def setup_overview_view():
    ...
    if st.button("Update traffic stats"):
        ...
        df_vehicles = update_traffic_stats(available_cameras.index.values.tolist())
